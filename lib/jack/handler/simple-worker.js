...
exports.run = function(app, options) {
    ...
    onrequest = function(request, response) {
        ...
        var uri = parse(String(request.getTarget()));
        ...
        function read(length){
        	if(!reader){
        		reader = new Packages.java.io.InputStreamReader(request.getInputStream(), this.encoding || "UTF-8");
        	}
    		...
    		var buffer;
    		var bytesRead = reader.read(buffer = Packages.java.nio.CharBuffer.allocate(4096))
    		if(bytesRead <= 0){
    			return "";
    		}
        	return String(new Packages.java.lang.String(buffer.array(), 0, bytesRead));
    	}
